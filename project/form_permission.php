...
if (isset($_POST['button'])) {
    ...
    permission_insert($regime, $du, $au, $id, $idRole, $idDepartement);
...
<body>
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="form_permission.php" class="active">
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Formulaire de permission de sortie</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                    <li class="breadcrumb-item">Forms</li>
                    <li class="breadcrumb-item active">Permission de sortie</li>
                </ol>
            </nav>
        </div>
        <!-- End Page Title -->
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Demande une permission de sortie</h5>

                <!-- General Form Elements -->
                <form method="post">
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label">Regime horaire : </label>
                        <div class="col-sm-10">
                            <select class="form-select" name="regime" id="regime" required>
                                <option value="">chosir l'heure</option>
                                <option value="8 H - 16 H 30">8 H - 16 H 30</option>
                                <option value="6 H - 14 H">6 H - 14 H</option>
                                <option value="14 H - 22 H">14 H - 22 H</option>
                                <option value="22 H - 6 H">22 H - 6 H</option>
                            </select>
                        </div>
                    </div>

                    <div class="row mb-3">
                        <label for="inputTime" class="col-sm-2 col-form-label">Temps de sortie : </label>
                        <div class="col-sm-10">
                            <input type="time" name="du" class="form-control" required>
                        </div>
                    </div>

                    <div class="row mb-3">
                        <label for="inputTime" class="col-sm-2 col-form-label">Temps de reprise : </label>
                        <div class="col-sm-10">
                            <input type="time" name="au" class="form-control">
                        </div>
                    </div>
