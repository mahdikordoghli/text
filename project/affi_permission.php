...
<body>
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="components-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="affi_permission.php" class="active">
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Demande de permission de sortie</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                    <li class="breadcrumb-item">Vos demande</li>
                    <li class="breadcrumb-item active">Demande de Permission de sortie</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-14">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Vos demandes :</h5>

                            <!-- Default Table -->
                            <?php
                            include './connection.php';
                            $id = $_SESSION['id'];
                            $sql = "SELECT idPermission, regimeHoraire, du, au, statut  FROM permissionsortie WHERE username = ?";
                            ...
                            if ($res->num_rows == 0) {
                                echo "Aucun demande de permission de sortie";
                            } else {
                                echo "<table class = 'table'>";
                                echo "<tr><th>IdDemande</th><th>Regime horaire</th><th>Du</th><th>Au</th><th>Statut</th></tr>";
                                while ($row = $res->fetch_assoc()) {
                                    echo "<tr>";
                                    echo "<td>" . $row['idPermission'] . "</td>";
                                    echo "<td>" . $row['regimeHoraire'] . "</td>";
                                    echo "<td>" . $row['du'] . "</td>";
                                    echo "<td>" . $row['au'] . "</td>";
