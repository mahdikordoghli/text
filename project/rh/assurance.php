...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="indexrh.php" class="logo d-flex align-items-center">
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="indexrh.php">
            ...
            <li class="nav-item">
                <a class="nav-link" href="assurance.php">
                    <i class="bi bi-card-list"></i>
                    <span>Insert Assurance</span>
                </a>
            </li><!-- End assurance Nav -->
    ...
    <main id="main" class="main">
        ...
        <form class="row g-3" method="post" enctype="multipart/form-data">
            ...
            <div class="text-center">
                ...
                <button type="reset" name="btnn" class="btn btn-secondary">Reset</button>
            </div>
        </form><!-- Vertical Form -->
    ...
    if (isset($_POST['btn'])) {
        ...
        $target_file = $target_dir . basename($_FILES["file"]["name"]); // Corrected file input name
        $uploadOk = 1;
        $imageFileType = strtolower(pathinfo($target_file, PATHINFO_EXTENSION));
        insert($target_dir, $target_file, $uploadOk, $imageFileType);
    }
    ?>
