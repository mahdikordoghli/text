...
require_once 'functions/function_formulaire.php';
...
//Debut demande conge
if (isset($_SESSION['id'], $_SESSION['idRole'], $_SESSION['idDepartement'])) {
  $id = $_SESSION['id'];
  $idRole = $_SESSION['idRole'];
...
if (isset($_POST['button'])) {
  // Collect and validate input (omitted for brevity)
  // ... validation logic for $conge, $dateSortie, and $dateReprise ...
  $conge = $_POST["conge"];
  $dateSortie = $_POST["dateSortie"];
  $dateReprise = $_POST["dateReprise"];
  conge_insert($conge, $dateSortie, $dateReprise, $idRole, $idDepartement, $id);
}
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="form_conge.php" class="active">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-menu-button-wide"></i><span>Vos demandes</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="sup.php">
  ...
  <main id="main" class="main">
    ...
    <div class="card">
      <div class="card-body">
        ...
        <form method="post" action="" onsubmit="submitForm()" id="myForm2">
          <div class="row mb-3">
            <label class="col-sm-2 col-form-label">Type de congé : </label>
            <div class="col-sm-10">
              <select class="form-select" aria-label="Default select example" name="conge" id="typeConge" required>
                <option value="">_ Type _</option>
                <option value="Congé payé">Congé payé</option>
                <option value="Congé sans solde">Congé sans solde</option>
                <option value="Congé Exceptionelle">Congé Exceptionelle</option>
                <option value="Téletravail">Téletravail</option>
          ...
          <div class="row mb-3">
            <label for="inputDate" class="col-sm-2 col-form-label">Date de sortie : </label>
            <div class="col-sm-10">
              <input type="date" id="startDate" name="dateSortie" class="form-control"
                value="<?php echo date('Y-m-d'); ?>" min="2018-01-01" max="2025-01-01">
            </div>
          </div>

          <div class="row mb-3">
            <label for="inputDate" class="col-sm-2 col-form-label">Date de reprise</label>
            <div class="col-sm-10">
              <input type="date" id="endDate" name="dateReprise" class="form-control"
                value="<?php echo date('Y-m-d'); ?>" min="2018-01-01" max="2025-01-01">
            </div>
          </div>
        ...
        <script>
          function submitForm() {
            ...
            if (startDate >= endDate) {
              alert("La date de reprise doit être après la date de sortie.");
              event.preventDefault();
            }

          }
        </script><!-- End script Form -->
