        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="components-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="affi_conge.php" class="active">
                ...
                <div class="col-lg-14">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            include './connection.php';
                            $id = $_SESSION['id'];
                            $sql = "SELECT idConge, typeConge, dateSortie, dateReprise, statut FROM demandeconge WHERE username = ?";
                            $stmt = $mysqli->prepare($sql);
                            $stmt->bind_param("s", $id);
                            $stmt->execute();
                            $res = $stmt->get_result();
                            if ($res->num_rows == 0) {
                                echo "No demande de conge";
                            } else {
                                echo "<table class = 'table'>";
                                echo "<tr><th>IdDemande</th><th>Type de congé</th><th>Date de sortie</th><th>Date de reprise</th><th>Statut</th></tr>";
                                while ($row = $res->fetch_assoc()) {
                                    echo "<tr>";
                                    echo "<td>" . $row['idConge'] . "</td>";
                                    echo "<td>" . $row['typeConge'] . "</td>";
                                    echo "<td>" . $row['dateSortie'] . "</td>";
                                    echo "<td>" . $row['dateReprise'] . "</td>";
