...
<body>
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="components-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="affi_badgeage.php" class="active">
    ...
    <main id="main" class="main">
        <div class="pagetitle">
            <h1>Signale du manque de bageage</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                    <li class="breadcrumb-item">Vos demande</li>
                    <li class="breadcrumb-item active">Signale du manque de bageage</li>
                </ol>
            </nav>
                ...
                <div class="col-lg-14">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            include './connection.php';
                            $id = $_SESSION['id'];
                            $sql = "SELECT idBadgeage ,date, entree, sortie, statut FROM badgeage WHERE username = ?";
                            ...
                            if ($res->num_rows == 0) {
                                echo "Aucun signale de manque de badgeage";
                            } else {
                                echo "<table class='table'>";
                                echo "<tr><th>IdDemande</th><th>Date</th><th>Entrée</th><th>Sortie</th><th>Statut</th></tr>";
                                while ($row = $res->fetch_assoc()) {
                                    echo "<tr>";
                                    echo "<td>" . $row['idBadgeage'] . "</td>";
                                    echo "<td>" . $row['date'] . "</td>";
                                    echo "<td>" . $row['entree'] . "</td>";
                                    echo "<td>" . $row['sortie'] . "</td>";
