...
<body>
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="components-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="affi_horaire.php" class="active">
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Demande de changement horaire</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                    <li class="breadcrumb-item">Vos demande</li>
                    <li class="breadcrumb-item active">Demande de changement horaire</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                ...
                <div class="col-lg-14">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            include './connection.php';
                            $id = $_SESSION['id'];
                            $sql = "SELECT id ,date, time, statut FROM changerregimehoraire WHERE username = ?";
                            ...
                            if ($res->num_rows == 0) {
                                echo "Aucun demande de changement de regime horaire";
                            } else {
                                echo "<table class = 'table'>";
                                echo "<tr><th>IdDemande</th><th>Date</th><th>Temps</th><th>Statut</th></tr>";
