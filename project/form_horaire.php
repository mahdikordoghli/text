...
if (isset($_POST['button'])) {
    ...
    $date = $_POST["date"];
    $time = $_POST["time"];
    horaire_insert($date, $time, $idRole, $idDepartement, $id);
}
...
<body>
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="form_horaire.php" class="active">
    ...
    <main id="main" class="main">
        <div class="pagetitle">
            <h1>Formulaire de changement de regime horaire</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                    <li class="breadcrumb-item">Forms</li>
                    <li class="breadcrumb-item active">Changement horaire</li>
                </ol>
            </nav>
        </div>
        <!-- End Page Title -->
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Demande un changement d'horaire</h5>
                ...
                <form method="post">
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select class="form-select" name="time" id="regime" required>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="date" id="start" name="date" class="form-control"
                                value="<?php echo date('Y-m-d'); ?>" min="2018-01-01" max="2025-01-01" required>
                        </div>
                    </div>
