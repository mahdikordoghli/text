...
if (isset($_POST['button'])) {
    ...
    badgeage_insert($date, $entre, $sortie, $idRole, $idDepartement, $id);
}
...
<body>
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="form_badgeage.php" class="active">
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Formulaire de Manque du badgeage</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                    <li class="breadcrumb-item">Forms</li>
                    <li class="breadcrumb-item active">Manque de badgeage</li>
                </ol>
            </nav>
        </div>
        <!-- End Page Title -->
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Signaler un manque de badgeage</h5>
                ...
                <form method="post">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label">horaires d'entrée : </label>
                        <div class="col-sm-10">
                            <select class="form-select" aria-label="Default select example" name="entre" id="entree"
                                required>
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label">horaires de sortie : </label>
                        <div class="col-sm-10">
                            <select class="form-select" aria-label="Default select example" name="sortie" id="sortie"
                                required>
                                <option value="">- Temps -</option>
                                <option value="16 H 30">16 H 30</option>
                                <option value="14 H">4 H</option>
                                <option value="22 H">22 H</option>
                                <option value="6 H">6 H</option>
                            </select>
                        </div>
