        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <img src="assets/img/profile.jfif" alt="Profile" class="rounded-circle">
              <h2><?php echo $name . " " . $prenom; ?></h2>
              <h3><?php echo $idRole ;?></h3>
            </div>
          </div>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo $name . " " . $prenom ?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Company</div>
                    <div class="col-lg-9 col-md-8">SEBN,TN2</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Job</div>
                    <div class="col-lg-9 col-md-8"><?php echo $idRole ;?></div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">+216<?php echo " ". $phone ;?></div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Solde</div>
                    <div class="col-lg-9 col-md-8"><?php echo $solde ;?></div>
                  </div>
